package com.example.BS12_CORS.persona.infraestructure.controller;


import com.example.BS12_CORS.estudiante.application.EstudianteService;
import com.example.BS12_CORS.exception.UnprocesableException;
import com.example.BS12_CORS.feign.FeignFallback;
...
import com.example.BS12_CORS.persona.application.PersonaService;
import com.example.BS12_CORS.profesor.application.ProfesorService;
